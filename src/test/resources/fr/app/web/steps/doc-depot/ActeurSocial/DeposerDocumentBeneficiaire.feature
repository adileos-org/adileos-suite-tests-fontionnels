...
Feature: [ DOC-DEPOT ] Déposer un document pour le bénéficiaire en tant qu'acteur social
...
Scenario: Déposer un document pour le bénéficiaire et suppression par le bénéficiaire
    ...
    And ACCDOCDEPACTSOC Cliquer sur le bouton 'Voir le détail' pour le bénéficiaire de nom 'BENEFICIAIRE' et de prénom 'Beneficiaire'
...
Scenario: Déposer un document pour le bénéficiaire et suppression par l'acteur social
    Given ACCDOCDEP Sur la page d'accueil 'DOC-DEPOT' avec le message 'LEGRAIS - Marie'
    ...
    And ACCDOCDEPBENEF Cliquer sur la catégorie de documents 'Autres'
    Then ACCDOCDEPBENEF_PREF_ESP Vérifier la présence du document ajouté 'doc.pdf'
    Then ACCDOCDEPACTSOC Vérifie la présence du bouton 'Supprimer' pour le document 'doc.pdf'
