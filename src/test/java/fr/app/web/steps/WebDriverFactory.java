...
public class WebDriverFactory {
    ...
    public static WebDriver get(String browserToUse) {
        ...
        if ("chrome".equalsIgnoreCase(browserToUse)) {
            ...
            String pathWebdriver = Utilitaires.getConfigurationProperty(WEBDRIVER_CHROME_DRIVER,
                    WEBDRIVER_CHROME_DRIVER, Constantes.webdriver_chrome_driver);
        ...
        if ("ie".equalsIgnoreCase(browserToUse)) {
            ...
            String pathWebdriver = Utilitaires.getConfigurationProperty(WEBDRIVER_IE_DRIVER, WEBDRIVER_IE_DRIVER,
                    Constantes.webdriver_ie_driver);
        ...
        if (webDriver == null) {
            logger.error("Le browser n'est pas correctement initialise avec " + browserToUse
                    + " (valeurs possibles : chrome, firefox, htmlunit, ie)");
        }

        if (webDriver != null) {
            // agrandi la taille de la fenetre
